                ...
                <div className="pnrp-coin-3d">
                  <div className="pnrp-coin-side pnrp-coin-front">
                    <svg viewBox="0 0 140 140" className="absolute inset-0 w-full h-full">
                      ...
                      <path d="M 26,42 A 50,50 0 0,1 114,42" stroke="white" strokeWidth="2" fill="none" opacity="0.6" />
                      <path d="M 26,95 A 50,50 0 0,0 114,95" stroke="white" strokeWidth="2" fill="none" opacity="0.6" />
                      
                      <text fill="white" fontSize="10" fontWeight="900" letterSpacing="0.5" textShadow="0 2px 4px rgba(0,0,0,0.5)">
                        <textPath href="#topCurve" startOffset="50%" textAnchor="middle">
                          PLATINUM • NETWORK
                        </textPath>
                      </text>
                      <text fill="white" fontSize="10" fontWeight="900" letterSpacing="0.7" textShadow="0 2px 4px rgba(0,0,0,0.5)">
